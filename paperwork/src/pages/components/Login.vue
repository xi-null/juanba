    ...
    <div class="login__form">
      <div class="login__form-username">
        <div class="login__form-username-img">
          <div class="login__form-username-imge"></div>
        </div>
      ...
      <div class="login__form-password">
        <div class="login__form-password-img">
          <div class="login__form-password-imge"></div>
        </div>
      ...
      <div class="login__form-btn">
        <button class="login__form-btn-submit" @click="Login()">提交</button>
      </div>
      <div class="login__form-otherbtn">
        <button class="login__form-otherbtn-submit">统一身份认证登录</button>
      </div>
    </div>
  </div>
</template>
  ...
  methods: {
    Login () {
      ...
      loginRequest({ username, password }).then(res => {
        console.log(res)
        if (res.errMsg === '请求成功.') {
          this.access_token = res.item.token.access_token
          window.localStorage.setItem('token', this.access_token)
          this.refresh_token = res.item.token.refresh_token
          window.localStorage.setItem('refresh_token', this.refresh_token)
          this.userid = res.item.user.id
